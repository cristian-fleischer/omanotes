...
```sh
curl -LO https://github.com/cristian-fleischer/omanotes/releases/download/v0.4.6/omanotes-0.4.6-1-x86_64.pkg.tar.zst
sudo pacman -U omanotes-0.4.6-1-x86_64.pkg.tar.zst
```
